...
class Stockq1 extends Component{
    ...
    constructor(){
      ...
      handleSubmit = (event) => {
        ...
        const request = async () => {
            const response = await fetch('http://localhost:8080/MonthwiseAvgClosePriceofaYear', {
                method: 'post',
    ...
    render(){
        ...
        const companylist = [
          ...
          const months = [new Date(this.state.year,0),new Date(this.state.year,1),new Date(this.state.year, 2),new Date(this.state.year, 3),
            new Date(this.state.year, 4),new Date(this.state.year, 5),new Date(this.state.year, 6),
            new Date(this.state.year, 7),new Date(this.state.year, 8),
            new Date(this.state.year, 9),new Date(this.state.year, 10),new Date(this.state.year, 11),
            ]; 
        const chartData = {
            labels: months,
            datasets:[
