...
class Stockq3 extends Component{
    ...
    constructor(){
      ...
      handleSubmit = (event) => {
        ...
        const request = async () => {
            const response = await fetch('http://localhost:8080/Regression', {
                method: 'post',
    ...
    render(){
        ...
        const companylist = [
          ...
          const months = ["Jan 17","Feb 17","Mar 17","Apr 17",
          "May 17","Jun 17","Jul 17","Aug 17","Sep 17","Oct 17","Nov 17","Dec 17",
          "Jan 2018","Feb 2018","Mar 218","Apr 18","May 18","Jun 18","Jul 18",
